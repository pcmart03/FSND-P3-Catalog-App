...
def fbconnect():
    ...
    app_id = json.loads(
        open('/var/www/FSND-P3-Catalog-App/catalog/catalog/fb-client-secrets.json', 'r').read())['web']['app_id']
    app_secret = json.loads(
        open('/var/www/FSND-P3-Catalog-App/catalog/catalog/fb-client-secrets.json', 'r').read())['web']['app_secret']
